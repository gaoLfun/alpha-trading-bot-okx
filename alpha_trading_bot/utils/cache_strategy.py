...
class ConfigAccessor:
    ...
    def get_ai_fusion_weights(self):
        """获取AI融合权重"""
        return getattr(self._config.ai, 'fusion_weights', {'deepseek': 0.6, 'qwen': 0.4})
...
# 全局配置访问器实例
config_accessor = ConfigAccessor()</content>
<parameter name="filePath">/Users/hamgua/code/github/alpha-trading-bot-okx/alpha_trading_bot/utils/config_accessor.py