...
class PromptBuilder:
    ...
    # 买入条件阈值 - 调整为更积极
    BUY_TREND_STRENGTH = 0.2  # 降低趋势强度要求（从0.3）
    BUY_RSI_THRESHOLD = 68  # 略微提高RSI阈值（从65）
    BUY_BB_POSITION = 65  # 放宽布林带位置要求（从60）
    BUY_ADX_THRESHOLD = 15  # 降低ADX要求（从20）
